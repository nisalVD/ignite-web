            ...
            <div className="user-info-form-sign-up">
              <form
                onSubmit={event => {
                  ...
                  onUpdateUser({ email, password, passwordConfirmation, firstName, lastName, dateOfBirth, address, postCode, state, mobileNumber })
                }}
              > 
                <label>
                {'email'}
                ...
                />
                <br />
                <button className="sign-in-button">UPDATE MY DETAILS</button>
              </form>
            </div>
        )
    }
